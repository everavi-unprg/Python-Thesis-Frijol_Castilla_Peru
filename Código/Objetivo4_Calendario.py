...
#*******************************************************************
# Razón de promedios para el Calendario de Lambayeque
vol_total_mes_lam = df_lam.groupby('Mes')[col_peso].sum().reset_index()
total_historico_lam = vol_total_mes_lam[col_peso].sum()

vol_total_mes_lam['Pct'] = (vol_total_mes_lam[col_peso] / total_historico_lam) * 100
cuota_promedio = vol_total_mes_lam.set_index('Mes').reindex(range(1, 13), fill_value=0).reset_index()
#*******************************************************************
...
guardar_imagen_tabla(tabla1_final, "Objetivo4_Tabla 1: Calendario Mensual Detallado", "Objetivo4_Tabla1_Visual.svg")
guardar_imagen_tabla(tabla2_final, "Objetivo4_Tabla 2: Calendario Estratégico Agrupado", "Objetivo4_Tabla2_Visual.svg")

print(f"¡Listo! Archivos generados en: {output_folder}")
print("1. Tabla1_Mensual.xlsx y Tabla1_Visual.svg (Original)")
print("2. Tabla2_Estrategica.xlsx y Tabla2_Visual.svg (Mejorada)")