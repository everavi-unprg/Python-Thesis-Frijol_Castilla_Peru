...
df_filtrada =df_filtrada[(df_filtrada['AÑO_DECLARACION']>=2013)&(df_filtrada['AÑO_DECLARACION']<=2024)]
...
nombre_salida = "Objetivo_1_Resultados_SENSIBILIDAD.xlsx"
...
try:
    ...
    print("Asegurarse que el archivo 'Objetivo_1_Resultados_SENSIBILIDAD.xlsx' no esté abierto.")